function dataset_diffed = differentiateDataset2(dataset, method, idx)
...
if strcmp(method, 'diff')
    ...
    for j = 1:size(dataset,1)
        ...
        pos_diffed = pos;
        vel_diffed = (pos_diffed(2:end,:) - pos_diffed(1:end-1,:))/dt;
        vel_diffed = [vel_diffed; vel_diffed(end,:)];
        
        acc_diffed = (vel_diffed(2:end,:) - vel_diffed(1:end-1,:))/dt;
        acc_diffed = [acc_diffed;  acc_diffed(end,:)];
